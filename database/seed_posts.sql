...
-- Insert sample posts
INSERT INTO posts (author_user_id, title, slug, summary, content_html, status, published_at, created_at) VALUES
...
INSERT INTO post_comments (post_id, author_name, author_email, content, rating, status, ip_address, created_at) VALUES
...
(3, 'Bùi Văn G', 'vang@example.com', 'Spam comment test', NULL, 'spam', '192.168.1.1', NOW()),
