...
class PageController extends Controller
{
    public function dashboard(): void
    {
        Auth::requireAdmin();
        $pdo = Database::conn();
        $stats = [ 'posts' => 0, 'drafts' => 0, 'comments_pending' => 0, 'users' => 0 ];
        ...
        try { $stats['comments_pending'] = (int)$pdo->query("SELECT COUNT(*) FROM comments WHERE status='pending'")->fetchColumn(); } catch (\Throwable $e) {}
